...
%%%tuning constraints
alpha = 0.9; %%%will accelerate the convergence time dominantly
aalpha = 0.75;
...
%%% The outermost forloop is the reality world
 ...
 while step <=20
        ...
        if step >=10
        A = [4.01 0.01 0; 0.01 1.01 0.01; 0 0.01 1.01];
        end
...
real = [5;5.36513073974633;0.646475056135397;0.146056180335710;0.254404590787362;0.351520058548873;0.212534967617323;0.318261540413968;0.188851695443479;0.122499351091673;0.144143364772306;0.151607679586848;0.0965617106460906;0.159868141935267;0.0892574249697734;0.230895900280011;1.01719036497157;0.367094172873579;0.209150557736537;0.173361393496157;0.181513927311535];
...
hold on
plot(sstep, real(1:num_step,1),'LineWidth',2)
hold on
...
set(yy,'Interpreter','latex','FontSize',30)
set(gca,'FontSize',20)
zz = legend('$||x_t||_{\infty}$ varied A', '$||x_t||_{\infty}$ fixed A');
set(zz,'Interpreter','latex','FontSize',30)
